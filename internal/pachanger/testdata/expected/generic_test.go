...
import "github.com/pyama86/pachanger/internal/pachanger/testdata/example"
...
func UseGenericTypes() {
	// ジェネリクス型の使用
	var g GenericType[example.MyInt]
	var m MultiGeneric[string, example.MyInt]
...
func UseGenericWithPackage[T any]() {
	var g GenericType[example.OtherExample]
}
